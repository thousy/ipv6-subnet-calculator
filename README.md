...
```text
IPv6SubnetCalculatorV1.2.4.exe
```
...
- GitHub Releases：上传 `IPv6SubnetCalculatorV1.2.4.exe` 作为 Windows 下载文件。
...
- `IPv6SubnetCalculatorV1.2.4.exe`：已编译的 Windows 单文件版本（V1.2.4）。
